...
/* Command for C compiler:
   gcc -c  -w  -I/home/john/code/Nim/lib -o /media/sf_D_DRIVE/Work/Code/nim-raytracer/src/src/nimcache/glm_glm.o /media/sf_D_DRIVE/Work/Code/nim-raytracer/src/src/nimcache/glm_glm.c */
